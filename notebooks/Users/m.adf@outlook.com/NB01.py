...
df = df.withColumn("FreightTax", col("Freight")*0.13).withColumn("TotalWithoutTax", col("TotalDue")-col("TaxAmt")).withColumn("ConstantValue", lit("Ontario"))
...
# MAGIC %sql
# MAGIC 
# MAGIC select * from SOH where SalesOrderID <= 105
